...
export default function Navbar() {
  ...
  return (
    <div className='fixed inset-0 bg-primary/40 z-20 backdrop-lg w-full'>
      <div className='mx-auto c-space max-w-7xl'>
        ...
        {isOpen && (
          <Motion.div className='text-center sm:hidden overflow-hidden pb-5 backdrop-blur-xs' initial={{opacity:0,x:-30}}
          animate={{opacity:1,x:0}} style={{maxHeight:"100vh"}}
